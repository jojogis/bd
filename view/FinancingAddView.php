...
class FinancingAddView implements ViewInterface
{
    private ProjectRepositoryInterface $projectRep;
    private InvestorRepositoryInterface $investRep;

    public function __construct(ProjectRepositoryInterface $projectRep,InvestorRepositoryInterface $investRep)
    {
    ...
    public function render(): void
    {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form action="/db_app/financing/insert">
                    <input type="hidden" name="id" >
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">Сумма</span>
                        </div>
                        <input name="total" type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
