...
class ProgrammerAddView implements ViewInterface
{
    ...
    public function render(): void
    {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form action="/db_app/programmers/insert">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="specialization" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="birthdate" placeholder="0000-00-00" aria-label="0000-00-00" class="date-input form-control" aria-describedby="basic-addon1">
                    </div>
