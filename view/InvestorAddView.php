...
class InvestorAddView implements ViewInterface
{
    ...
    public function render(): void
    {
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form action="/db_app/investors/insert">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="address" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
